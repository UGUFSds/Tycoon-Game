...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_PickupThrow');
	...
	Moghunter.pick_list = {};
	for (Moghunter.i = 1; Moghunter.i <= Moghunter.pick_list_length ; ++Moghunter.i) {
	  Moghunter.line = "String(Moghunter.parameters['角色-" + Moghunter.i + "-举起姿势'])";
	  Moghunter.pick_list[Moghunter.i] = eval(Moghunter.line);
	};
