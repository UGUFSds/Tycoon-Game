...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_MenuParticles');
	...
	Moghunter.mpart_ox = Number(Moghunter.parameters['速度-X轴方向'] || 0);
	Moghunter.mpart_oy = Number(Moghunter.parameters['速度-Y轴方向'] || -1);
	Moghunter.mpart_a = Number(Moghunter.parameters['旋转速度'] || 1);
	Moghunter.mpart_number = Number(Moghunter.parameters['粒子数量'] || 15);
	Moghunter.mpart_blendMode = Number(Moghunter.parameters['混合模式'] || 1);
