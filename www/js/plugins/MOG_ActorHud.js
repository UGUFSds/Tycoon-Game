...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_ActorHud');
	...
	Moghunter.ahudFace_list_length = 20;
	Moghunter.ahudFace_list = {};
	for (Moghunter.i = 1; Moghunter.i <= Moghunter.ahudFace_list_length ; ++Moghunter.i) {
	  Moghunter.line = "String(Moghunter.parameters['角色头像-" + Moghunter.i + "'] )";
	  Moghunter.ahudFace_list[Moghunter.i] = eval(Moghunter.line);
	};
//=============================================================================
// ** ImageManager
//=============================================================================
