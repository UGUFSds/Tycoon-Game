...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_SceneItem');
	...
	Moghunter.scItem_WlayoutX = Number(Moghunter.parameters['平移-布局 X'] || 0);
	Moghunter.scItem_WlayoutY = Number(Moghunter.parameters['平移-布局 Y'] || 0);  
	...
	Moghunter.scItem_ActorParFontSize = Number(Moghunter.parameters['角色能力值组字体大小'] || 20);
    ...
    Moghunter.scItem_PartyX_hide = Number(Moghunter.parameters['平移-选择框-隐藏 X'] || 10); 
    ...
    Moghunter.scItem_PartyY_last = Number(Moghunter.parameters['平移-选择框-上一个 Y'] || 240);
    Moghunter.scItem_PartyX_next = Number(Moghunter.parameters['平移-选择框-下一个 X'] || 10); 
    Moghunter.scItem_PartyY_next = Number(Moghunter.parameters['平移-选择框-下一个 Y'] || 240);
	...
	Moghunter.src_item_menu_Layout = String(Moghunter.parameters['资源-布局']);
	...
	for (Moghunter.i = 1; Moghunter.i <= Moghunter.menu_item_face_list_length ; ++Moghunter.i) {
	  Moghunter.line = "String(Moghunter.parameters['角色头像-" + Moghunter.i + "'] )";
	  Moghunter.menu_item_face_list[Moghunter.i] = eval(Moghunter.line);
	};
