 ...
 * @param 命令面板起点 X
 * @parent 是否使用命令面板布局
 * @desc 命令面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的x轴值，单位像素。（可为负数）
 * @default 0 
 *
 * @param 命令面板起点 Y
 * @parent 是否使用命令面板布局
 * @desc 命令面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的y轴值，单位像素。（可为负数）
 * @default 64
 *
 * @param ---战斗回合面板---
 * @default  
 ...
 * @param 战斗回合面板起点 X
 * @parent 是否使用战斗回合面板布局
 * @desc 战斗回合面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的x轴值，单位像素。（可为负数）
 * @default 0    
 *
 * @param 战斗回合面板起点 Y
 * @parent 是否使用战斗回合面板布局
 * @desc 战斗回合面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的y轴值，单位像素。（可为负数）
 * @default -150
 *
 * @param ---帮助面板---
 * @default  
 ...
 * @param 帮助面板起点 X
 * @parent 是否使用帮助面板布局
 * @desc 帮助面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的x轴值，单位像素。（可为负数）
 * @default 0    
 *
 * @param 帮助面板起点 Y
 * @parent 是否使用帮助面板布局
 * @desc 帮助面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的y轴值，单位像素。（可为负数）
 * @default -150
 *
 * @param ---技能选择面板---
 * @default  
 ...
 * @param 资源-技能选择面板
 * @parent 是否使用技能选择面板布局
 * @desc 技能选择面板的图片资源。这是技能选择面板，不是技能类型面板。
 * @default 战斗窗口-技能选择面板
 * @require 1
 * @dir img/battlehud/
 * @type file
 ...
 * @param 技能选择面板起点 X
 * @parent 是否使用技能选择面板布局
 * @desc 技能选择面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的x轴值，单位像素。（可为负数）
 * @default 0    
 *
 * @param 技能选择面板起点 Y
 * @parent 是否使用技能选择面板布局
 * @desc 技能选择面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的y轴值，单位像素。（可为负数）
 * @default 100
 *
 * @param ---物品选择面板---
 * @default  
 ...
 * @param 物品选择面板起点 X
 * @parent 是否使用物品选择面板布局
 * @desc 物品选择面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的x轴值，单位像素。（可为负数）
 * @default 0    
 *
 * @param 物品选择面板起点 Y
 * @parent 是否使用物品选择面板布局
 * @desc 物品选择面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的y轴值，单位像素。（可为负数）
 * @default 150
 *
 * @param ---角色选择面板---
 * @default  
 ...
 * @param 角色选择面板起点 X
 * @parent 是否使用角色选择面板布局
 * @desc 角色选择面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的x轴值，单位像素。（可为负数）
 * @default 0    
 *
 * @param 角色选择面板起点 Y
 * @parent 是否使用角色选择面板布局
 * @desc 角色选择面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的y轴值，单位像素。（可为负数）
 * @default 150
 *
 * @param ---敌人选择面板---
 * @default  
 ...
 * @param 敌人选择面板起点 X
 * @parent 是否使用敌人选择面板布局
 * @desc 敌人选择面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的x轴值，单位像素。（可为负数）
 * @default 0    
 *
 * @param 敌人选择面板起点 Y
 * @parent 是否使用敌人选择面板布局
 * @desc 敌人选择面板初始会出现在偏移的起点位置，然后滑动到原本的位置，这里设置的是偏移的y轴值，单位像素。（可为负数）
 * @default 150
 *
 * @param ---自定义角色位置---
 * @default   
 ...
 * @param 角色位置 2
 * @parent ---自定义角色位置---
 * @desc 固定第二个角色头像的位置，填入 x,y 的坐标。
 * 比如：200,200 不填则不固定位置。
 * @default
 *
 * @param 角色位置 3
 * @parent ---自定义角色位置---
 * @desc 固定第三个角色头像的位置，填入 x,y 的坐标。
 * 比如：200,200 不填则不固定位置。
 * @default
 *
 * @param 角色位置 4
 * @parent ---自定义角色位置---
 * @desc 固定第四个角色头像的位置，填入 x,y 的坐标。
 * 比如：200,200 不填则不固定位置。
 * @default
 *
 * @param 角色位置 5
 * @parent ---自定义角色位置---
 * @desc 固定第五个角色头像的位置，填入 x,y 的坐标。
 * 比如：200,200 不填则不固定位置。
 * @default
 *
 * @param 角色位置 6
 * @parent ---自定义角色位置---
 * @desc 固定第六个角色头像的位置，填入 x,y 的坐标。
 * 比如：200,200 不填则不固定位置。
 * @default
 *
 * @param 角色位置 7
 * @parent ---自定义角色位置---
 * @desc 固定第七个角色头像的位置，填入 x,y 的坐标。
 * 比如：200,200 不填则不固定位置。
 * @default
 *
 * @param 角色位置 8
 * @parent ---自定义角色位置---
 * @desc 固定第八个角色头像的位置，填入 x,y 的坐标。
 * 比如：200,200 不填则不固定位置。
 * @default
 *
 *
 ...
 * -----------------------------------------------------------------------------
 * ----插件影响
 * MOG_BattleCursor 单位选择指针 会将该插件中的 角色选择面板 
 * 和 敌人选择面板 屏蔽，并换成可以选择的指针。
 * （单位选择指针插件可以独立运行）
 *
 * -----------------------------------------------------------------------------
 * ----可选设定
...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_BattleHud');
	...
	Moghunter.bhud_slideX = Number(Moghunter.parameters['窗口起点 X'] || 0);
	Moghunter.bhud_slideY = Number(Moghunter.parameters['窗口起点 Y'] || 250);
    ...
    Moghunter.bhud_com_slideX = Number(Moghunter.parameters['命令面板起点 X'] || 0);
    Moghunter.bhud_com_slideY = Number(Moghunter.parameters['命令面板起点 Y'] || 64);
    ...
    Moghunter.bhud_party_slide_x = Number(Moghunter.parameters['战斗回合面板起点 X'] || 0);
    Moghunter.bhud_party_slide_y = Number(Moghunter.parameters['战斗回合面板起点 Y'] || -150);
	...
	Moghunter.bhud_help_slide_x = Number(Moghunter.parameters['帮助面板起点 X'] || 0);
    Moghunter.bhud_help_slide_y = Number(Moghunter.parameters['帮助面板起点 Y'] || -150);	
	...
	Moghunter.bhud_skill_slide_x =  Number(Moghunter.parameters['技能选择面板起点 X'] || 0);
    Moghunter.bhud_skill_slide_y =  Number(Moghunter.parameters['技能选择面板起点 Y'] || 100);	
	...
	Moghunter.bhud_item_slide_x =  Number(Moghunter.parameters['物品选择面板起点 X'] || 0);
    Moghunter.bhud_item_slide_y =  Number(Moghunter.parameters['物品选择面板起点 Y'] || 150);	
    ...
    // ACTOR WINDOWS
	Moghunter.bhud_actor_maxcols = Number(Moghunter.parameters['角色选择面板列数'] || 1);
    ...
    Moghunter.bhud_actor_slide_x = Number(Moghunter.parameters['角色选择面板起点 X'] || 0);
    Moghunter.bhud_actor_slide_y = Number(Moghunter.parameters['角色选择面板起点 Y'] || 150);	
    ...
    Moghunter.bhud_enemy_slide_x = Number(Moghunter.parameters['敌人选择面板起点 X'] || 0);
    Moghunter.bhud_enemy_slide_y = Number(Moghunter.parameters['敌人选择面板起点 Y'] || 150);
	...
	Moghunter.src_a_Layout = String(Moghunter.parameters['资源-角色窗口']);
	Moghunter.src_a_Layout2 = String(Moghunter.parameters['资源-最前框']);
	Moghunter.src_a_Turn = String(Moghunter.parameters['资源-轮到图形']);
	...
	Moghunter.src_a_Layout_Screen = String(Moghunter.parameters['资源-屏幕整体布局']);
	Moghunter.src_a_Layout_Command = String(Moghunter.parameters['资源-命令面板']);
	Moghunter.src_a_Layout_Party = String(Moghunter.parameters['资源-战斗回合面板']);
	Moghunter.src_a_Layout_Help = String(Moghunter.parameters['资源-帮助面板']);
	Moghunter.src_a_Layout_Skill = String(Moghunter.parameters['资源-技能选择面板']);
	Moghunter.src_a_Layout_Item = String(Moghunter.parameters['资源-物品选择面板']);
	Moghunter.src_a_Layout_Actor = String(Moghunter.parameters['资源-角色选择面板']);
	Moghunter.src_a_Layout_Enemy = String(Moghunter.parameters['资源-敌人选择面板']);
	
	Moghunter.actFace_list_length = 60;
	Moghunter.actFace_list = {};
	for (Moghunter.i = 1; Moghunter.i <= Moghunter.actFace_list_length ; ++Moghunter.i) {
	  Moghunter.line = "String(Moghunter.parameters['角色头像-" + Moghunter.i + "'] )";
	  Moghunter.actFace_list[Moghunter.i] = eval(Moghunter.line);
	};
